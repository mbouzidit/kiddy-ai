...
en: {
  ...
  hg_inst:"Tap a health PROBLEM → then tap the AI SOLUTION that fixes it!",
  hg_prob:"Health Challenges",
  hg_sol:"AI Solutions",
  hg_done:"🎉 All matched! Amazing work!",
  hg_wrong:"Try again! 💪",
  pg_title:"Sort the AI Solutions! 🌍",
  pg_inst:"Tap an AI tool → then tap its category to sort it!",
...
fr: {
  ...
  hg_inst:"Appuie sur un PROBLÈME → puis sur la SOLUTION IA qui le résout !",
  hg_prob:"Défis Santé",
  hg_sol:"Solutions IA",
  hg_done:"🎉 Tout associé ! Bravo !",
  hg_wrong:"Réessaie ! 💪",
  pg_title:"Trie les solutions IA ! 🌍",
  pg_inst:"Appuie sur un outil IA → puis sur sa catégorie pour le trier !",
